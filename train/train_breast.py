    ...
    def load_pairs(self):
        ...
        for personid in self.data.keys():
            ...
            # print(len(self.data[personid].keys()))
                ...
                print("Error in load_pairs: ", personid)
                continue
...
class MLPRunner(RunnerBase):
    ...
    def epoch_end_hook(self, info):
        ...
        if (info['cur_epoch'] + 1) % 2 == 0:
            torch.save({
                'epoch': info['cur_epoch'],  # 假设你训练了5个epochs
                'model_state_dict': self.model.state_dict(),
                'optimizer_state_dict': self.optimizer.state_dict(),
            }, f"/data2/xcg_data/lavis_data/Breast_images/checkpoint/breast_checkpoint_{info['cur_epoch']}.pth")
        print(info)
...
# resume a checkpoint
# checkpoint = torch.load("/home/xcg/medical-research/Project23us/checkpoints/mlp_checkpoint_1.pth", map_location = "cpu")
