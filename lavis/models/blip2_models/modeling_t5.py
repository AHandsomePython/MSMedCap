...
class T5Stack(T5PreTrainedModel):
    ...
    def parallelize(self, device_map=None):
        ...
        # print("showing self.device_map", self.device_map)
        ...
        # lyz modifies here
        print("showing first and last device !!! ", self.first_device, self.last_device)
    ...
    def forward(
        ...
        for i, (layer_module, past_key_value) in enumerate(
            ...
            if self.model_parallel:
                # lyz modifies here
                # print("showing device here: ", hidden_states.device, self.first_device, self.last_device)
